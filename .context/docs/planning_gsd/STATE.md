...
- 2026-04-30: após documentar o workflow, o script voltou a passar em `python3 -m py_compile zotero_sync_webdav.py zotero_diagnostico.py zotero_remove_duplicatas.py zotero_mirror_collections_to_obsidian.py`.
